...
<div class="row">
    <div class="col-sm-12">
        ...
        <form action="{{ route('souscription.store') }}" method="POST">
            @csrf
             <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <select class="form-control" name="sexe" required="">
                                            ...
                                            <option value="h" {{old('sexe')=="homme" ? "selected" : '' }} >Homme</option>
                                            <option value="f" {{old('sexe')=="femme" ? "selected" : '' }} >Femme</option>
                                        </select>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
...
<script>
    ...
    var offre_id =  $("#offre_id").children("option:selected").val();
   // $(".offre").val(offre_id);
   // $(".departement").val("");
    $(".commune").val("");
    ...
    $("#commune_id").empty();
        ...
        $.ajax({
            type:'GET',
            url:url_app+'/departement/by/offre/'+offre_id,
