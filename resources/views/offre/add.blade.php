...
@section('title', '| Enregister Offre')
    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="btn-group float-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('offre.index') }}" >AJOUTER UNE OFFRE</a></li>
            ...
            @csrf
             <div class="card">
                        <div class="card-header  text-center">
                            ...
                            <div class="text-center"> FORMULAIRE D'ENREGISTREMENT D'UNE OFFRE</div></div>
                            <div class="card-body">
                                @if ($errors->any())
