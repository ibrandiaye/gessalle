...
@section('title', '| Enregister Message')
    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="btn-group float-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('message.index') }}" >AJOUTER UNE MESSAGE</a></li>
            ...
            @csrf
             <div class="card">
                        <div class="card-header  text-center">
                            ...
                            <div class="text-center"> FORMULAIRE D'ENREGISTREMENT D'UNE MESSAGE</div></div>
                            <div class="card-body">
                                @if ($errors->any())
